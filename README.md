...
7["number literal"] ==> 11["number"]
8["(regular) enum"] ==> 11["number"]
9["enum literal"] ==> 11["number"]
10["enum literal member"] ==> 11["number"]
11["number"] ==> 2["{}"]
11["number"] ==> 8["(regular) enum"]
11["number"] ==> 9["enum literal"]
11["number"] ==> 10["enum literal member"]
12["boolean"] ==> 2["{}"]
13["true"] ==> 12["boolean"]
14["false"] ==> 12["boolean"]
15["bigint"] ==> 2["{}"]
...
8["(regular) enum"] -.-x 9["enum literal"]
8["(regular) enum"] -.-x 10["enum literal member"]
9["enum literal"] -.-x 0["non primitive (object)"]
9["enum literal"] -.-x 8["(regular) enum"]
9["enum literal"] -.-x 10["enum literal member"]
10["enum literal member"] -.-x 0["non primitive (object)"]
10["enum literal member"] -.-x 8["(regular) enum"]
11["number"] -.-x 0["non primitive (object)"]
